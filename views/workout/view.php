...
/** @var app\models\generated\[] $workoutWorkoutExercisesExercises */
...
<div class="workout-view">
        ...
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="btn-group" role="group">
                    ...
                    <?= Html::a('<i class="bi bi-trash"></i> Usun', ['delete', 'id' => $workout->id], [
    ...
    <div class="card shadow-sm">
        <div class="card-header bg-white d-flex justify-content-between align-items-center py-3">
            ...
            <?= Html::a('<i class="bi bi-plus-circle me-1"></i> Dodaj cwiczenie', ['add-exercise', 'workout_id' => $workout->id], ['class' => 'btn btn-success']) ?>
        </div>
        <div class="card-body p-0">
            <?php if (empty($workoutExercises)): ?>
                <div class="text-center py-5">
                    <i class="bi bi-emoji-frown display-1 workout-muted"></i>
                    <p class="workout-muted mt-3 mb-0">Ten trening nie zawiera zadnych cwiczen.</p>
                    <?= Html::a('<i class="bi bi-plus-lg me-1"></i>Dodaj pierwsze cwiczenie', ['add-exercise', 'workout_id' => $workout->id], ['class' => 'btn btn-outline-success mt-2']) ?>
                </div>
            <?php else: ?>
                    ...
                    <table class="table table-hover mb-0">
                        <thead class="table-light">
                            <tr>
                                ...
                                <th>
                                    <i class="bi bi-activity me-1"></i>Cwiczenie
                                </th>
                                <th class="text-center">
                                    <i class="bi bi-layers me-1"></i>Serie
                                </th>
                                <th class="text-center">
                                    <i class="bi bi-arrow-repeat me-1"></i>Powtorzenia
                                </th>
                                <th class="text-center">
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group btn-group-sm" role="group">
                                            ...
                                            <?= Html::a('<i class="bi bi-trash"></i>', ['delete-exercise', 'id' => $we->id], [
                                                ...
                                                'title' => 'Usun',
                                                'data' => [
                                                    'confirm' => 'Czy na pewno chcesz usunac to cwiczenie z treningu?',
                                                    'method' => 'post',
                                                ],
                                            ]) ?>
                                        </div>
    ...
    <!-- Back Button -->
    <div class="mt-4">
        <?= Html::a('<i class="bi bi-arrow-left me-1"></i> Wroc do listy', ['index'], ['class' => 'btn btn-outline-secondary']) ?>
    </div>
</div>
