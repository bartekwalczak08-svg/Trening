...
$this->title = Yii::t('app', 'Edytuj ćwiczenie');
        ...
        <div class="card-body">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        <input type="number" min="0" name="WorkoutExercises[duration_sec]" class="form-control" placeholder="<?= Yii::t('app', 'np. 60') ?>" value="<?= Html::encode($durationValue) ?>">
                        <?= Html::dropDownList(
