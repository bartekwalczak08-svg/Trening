...
<div class="flex-grow-1 p-4">
    ...
    <h3>Kalendarz Treningow</h3>
    <div class="card p-4">
        <div class="d-flex justify-content-between align-items-center mb-3">
            <h4 class="mb-0"></h4>
            <div class="text-muted small">Tydzien - Miesiac</div>
        ...
        <div class="row g-2">
            <div class="col"><div class="day"></div>
            <div class="col"><div class="day"></div>
            <div class="col"><div class="day"></div>
            <div class="col"><div class="day workout-push"><br><small></small></div>
            <div class="col"><div class="day workout-pull"><br><small></small></div>
            <div class="col"><div class="day workout-legs"><br><small></small></div>
            <div class="col"><div class="day today"><br><small></small></div>

            <div class="col"><div class="day workout-push"></div>
            <div class="col"><div class="day"></div>
            <div class="col"><div class="day workout-pull"></div>
            <div class="col"><div class="day"></div>
            <div class="col"><div class="day workout-legs"></div>
            <div class="col"><div class="day"></div>
            <div class="col"><div class="day"></div>
        </div>
</div>
